...
using Ambev.DeveloperEvaluation.MessageBroker.RabbitMQ.Configuration;
    ...
    public static void Main(string[] args)
    {
        try
        {
            ...
            builder.Services.AddSingleton<RabbitMQConnectionManager>(sp =>
            {
                ...
                return new RabbitMQConnectionManager(config.HostName, config.UserName, config.Password);
            });
